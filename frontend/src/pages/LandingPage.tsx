...
export const LandingPage: React.FC = () => {
  return (
    <div className="min-h-screen w-full bg-[#D3D0C2] bg-gradient-to-br from-[#E8E6DE] via-[#D3D0C2] to-[#B8C1B7] text-[#2D312D] overflow-hidden relative font-sans isolation-auto">
      <Navbar />
